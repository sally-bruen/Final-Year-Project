...
def process_file(filename, wordlist):
    ...
    for content, word in zip(content_words, text):
        if 'Np' in content: # Np is the POS tag for porper nouns
...
def main():
    ...
    excel_file_path = '/Users/sallybruen/PycharmProjects/TextPrograms/TestFiles/NcTokenFrequency.xlsx'  # path to output file
