...
def process_file(filename, wordlist):
    ...
    for content, type in zip(content_words, text):
        if 'Nc' in content:
            content_word_without_punctuation = type.lower()
            ...
            if content_word_without_punctuation not in types:
                types.append(content_word_without_punctuation)
            ...
            continue
    total_content = word_counts['TYPES']
...
def main():
    ...
    excel_file_path = '/Users/sallybruen/PycharmProjects/TextPrograms/TestFiles/NcTypeFrequency.xlsx'
