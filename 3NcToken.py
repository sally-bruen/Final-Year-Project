...
def process_file(filename, wordlist):
    ...
    for content, word in zip(content_words, text):
        ...
        # Check if the word without punctuation is in the wordlist
            ...
            continue
    total_content = word_counts['TOKENS']
...
def main():
    ...
    excel_file_path = '/Users/sallybruen/PycharmProjects/TextPrograms/TestFiles/NcTokenFrequency.xlsx'

    fieldnames = ['FILENAME', 'TOKENS', '100C', '300C', '500C', '1000C', '2000C', '3000C', '4000C',
